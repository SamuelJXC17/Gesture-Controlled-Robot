...
void loop() {
  ...
  //if (b_val == 1)
  {
    ...
    if (f1_val < 70 && f2_val < 70 && f3_val < 70 && f4_val < 70) //None = Stop
    {
    ...
    if (f1_val < 70 && f2_val > 70 && f3_val < 70 && f4_val < 70) // 2 = reverse
    {
      analogWrite(speedPinA, 255);
    ...
    if (f1_val < 70 && f2_val < 70 && f3_val > 70 && f4_val < 70) //  3 = Forward Turn A
    {
      analogWrite(speedPinB, 255);
      digitalWrite(dir1PinB, LOW);
      digitalWrite(dir2PinB, HIGH);
    ...
    if (f1_val < 70 && f2_val < 70 && f3_val < 70 && f4_val > 70) // 4 = Forward Turn B
    {
      analogWrite(speedPinA, 255);
      digitalWrite(dir1PinA, LOW);
      digitalWrite(dir2PinA, HIGH);
